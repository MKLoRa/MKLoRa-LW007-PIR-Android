# LW007 Android SDK Guide（English）
...
2.`EventBus` is used in the SDK and can be modified in `LoRaLW007MokoSupport` if you want to use other communication methods.

...
import com.moko.lw007.databinding.Lw007DialogPasswordBinding;
import com.moko.lw007.utils.ToastUtils;

public class PasswordDialog extends BaseDialog<Lw007DialogPasswordBinding> {
    ...
    @Override
    protected Lw007DialogPasswordBinding getViewBind() {
        return Lw007DialogPasswordBinding.inflate(getLayoutInflater());
    }

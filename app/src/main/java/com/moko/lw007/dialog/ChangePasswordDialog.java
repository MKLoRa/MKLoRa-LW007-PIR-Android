...
import com.moko.lw007.databinding.Lw007DialogChangePasswordBinding;
import com.moko.lw007.utils.ToastUtils;


public class ChangePasswordDialog extends BaseDialog<Lw007DialogChangePasswordBinding> {
    ...
    @Override
    protected Lw007DialogChangePasswordBinding getViewBind() {
        return Lw007DialogChangePasswordBinding.inflate(getLayoutInflater());
    }

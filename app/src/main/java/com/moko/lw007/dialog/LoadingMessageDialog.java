...
import com.moko.lw007.databinding.Lw007DialogLoadingMessageBinding;
import com.moko.lw007.view.ProgressDrawable;

import androidx.annotation.StringRes;
import androidx.core.content.ContextCompat;

public class LoadingMessageDialog extends MokoBaseDialog<Lw007DialogLoadingMessageBinding> {
    ...
    @Override
    protected Lw007DialogLoadingMessageBinding getViewBind(LayoutInflater inflater, ViewGroup container) {
        return Lw007DialogLoadingMessageBinding.inflate(inflater, container, false);
    }

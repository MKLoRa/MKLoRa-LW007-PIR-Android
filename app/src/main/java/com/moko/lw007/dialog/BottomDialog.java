...
import com.moko.lw007.databinding.Lw007DialogBottomBinding;

import java.util.ArrayList;

public class BottomDialog extends MokoBaseDialog<Lw007DialogBottomBinding> {
    ...
    @Override
    protected Lw007DialogBottomBinding getViewBind(LayoutInflater inflater, ViewGroup container) {
        return Lw007DialogBottomBinding.inflate(inflater, container, false);
    }

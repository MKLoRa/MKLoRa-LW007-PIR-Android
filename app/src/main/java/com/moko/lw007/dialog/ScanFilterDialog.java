...
import com.moko.lw007.databinding.Lw007DialogScanFilterBinding;

public class ScanFilterDialog extends com.moko.lw007.dialog.BaseDialog<Lw007DialogScanFilterBinding> {
    private int filterRssi;
    private String filterName;

    @Override
    protected Lw007DialogScanFilterBinding getViewBind() {
        return Lw007DialogScanFilterBinding.inflate(getLayoutInflater());
    }

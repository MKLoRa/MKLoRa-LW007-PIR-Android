...
import com.moko.lw007.databinding.Lw007ActivityAboutBinding;
import com.moko.lw007.utils.Utils;


public class AboutActivity extends BaseActivity {
    private Lw007ActivityAboutBinding mBind;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        mBind = Lw007ActivityAboutBinding.inflate(getLayoutInflater());

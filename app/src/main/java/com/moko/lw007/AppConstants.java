...
public class AppConstants {
    ...
    // action
    // sp
    public static final String SP_NAME = "sp_name_lw007";

    public static final String SP_KEY_DEVICE_ADDRESS = "sp_key_device_address";
    public static final String SP_KEY_SAVED_PASSWORD_LW007 = "SP_KEY_SAVED_PASSWORD_LW007";
    // extra_key
    // 设备列表\
    ...
    public static final String EXTRA_KEY_FIRMWARE_VERSION = "EXTRA_KEY_FIRMWARE_VERSION";
    // request_code

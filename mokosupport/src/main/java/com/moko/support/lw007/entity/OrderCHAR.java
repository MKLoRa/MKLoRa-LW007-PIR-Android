...
public enum OrderCHAR implements Serializable {
    ...
    CHAR_PIR(UUID.fromString("0000AA02-0000-1000-8000-00805F9B34FB")),
    CHAR_HALL_STATUS(UUID.fromString("0000AA03-0000-1000-8000-00805F9B34FB")),
    CHAR_TH(UUID.fromString("0000AA04-0000-1000-8000-00805F9B34FB")),
    CHAR_PARAMS(UUID.fromString("0000AA05-0000-1000-8000-00805F9B34FB")),
    CHAR_CONTROL(UUID.fromString("0000AA06-0000-1000-8000-00805F9B34FB")),
    CHAR_LOG(UUID.fromString("0000AA07-0000-1000-8000-00805F9B34FB")),
    ;
